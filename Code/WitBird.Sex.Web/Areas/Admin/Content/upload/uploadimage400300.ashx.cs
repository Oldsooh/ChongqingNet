...
{
    /// <summary>
    /// uploadimage400300 的摘要说明
    /// </summary>
    public class uploadimage400300 : IHttpHandler
    {
        int width = 838;
        int height = 382;
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //存放图片的根目录 
            string folderName = "/uploadfiles/slide/";
                ...
                if (postFile != null)
                {
                    ...
                    if (contentLength <= 1024 * 2048)
                    {
                        ...
                        try
                        {
                            ...
                            ImageUtility.CutForCustom(oldFile, thumbnail, width, height);
