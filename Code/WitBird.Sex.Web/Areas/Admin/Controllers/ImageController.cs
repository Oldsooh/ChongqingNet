...
namespace WitBird.Sex.Web.Areas.Admin.Controllers
{
    public class ImageController : Controller
    {
        ...
        public ActionResult Index(string categoryId, string keywords, string page, int isShow = 1)
        {
            ...
            //专辑列表
            int tempCount = 0;
            model.AlbumList = albumService.GetAlbumList(categoryId, keywords, 15, tempPage, out tempCount, isShow);
            //分页
